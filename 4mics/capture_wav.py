...
El WAV tiene:
    ...
    - sin procesamiento: lo mismo que el ESP32 envió por serial
      (idéntico a lo que lee audio_input.py para main.py)
...
try:
    ...
    print("X pyserial no instalado. Ejecutá: pip3 install pyserial", file=sys.stderr)
    sys.exit(2)
...
def open_serial(port, baud):
    ...
    # DTR bajo mantiene GPIO0 alto y el pulso de RTS reinicia).
    ser.dtr = False
    ser.rts = True
    time.sleep(0.1)
    ser.rts = False
